...
import { TrendingUp, TrendingDown, ArrowUpRight, DollarSign, Users, Zap, Clock, Car } from 'lucide-react';
import { 
...
const AnalyticsPage = () => {
  ...
  return (
    <motion.div initial="initial" animate="animate" transition={{ staggerChildren: 0.08 }}>
      ...
      <motion.div className="admin-grid-2 admin-section-gap admin-responsive-grid-main" style={{ gridTemplateColumns: '1.8fr 1fr' }} variants={fadeUp} transition={{ duration: 0.4, delay: 0.2 }}>
        {/* Revenue Trend Chart */}
            ...
            {fleetUtilization.map((f, i) => (
              <div key={i}>
                ...
                <div style={{ height: 8, background: 'rgba(255,255,255,0.04)', borderRadius: 6, overflow: 'hidden' }}>
                  <div style={{ height: '100%', width: `${f.rate}%`, background: f.color, borderRadius: 6, transition: 'width 1s ease', boxShadow: `0 0 10px ${f.color}30` }} />
                </div>
              </div>
            ))}
          </div>
      ...
      <motion.div className="admin-grid-2 admin-section-gap admin-responsive-grid-main" style={{ gridTemplateColumns: '1.4fr 1fr' }} variants={fadeUp} transition={{ duration: 0.4, delay: 0.4 }}>
              ...
              <BarChart data={revenueByVehicle} layout="vertical" margin={{ top: 5, right: 25, left: 5, bottom: 5 }}>
                <defs>
                  ...
                  <filter id="goldGlow" x="-10%" y="-10%" width="130%" height="130%">
                    <feDropShadow dx={2} dy={0} stdDeviation={3} floodColor="#c9a84c" floodOpacity={0.25} />
                  </filter>
                </defs>
      ...
      <motion.div className="admin-grid-2 admin-section-gap admin-responsive-grid-main" variants={fadeUp} transition={{ duration: 0.4, delay: 0.5 }}>
        {/* Client Sources (Improved) */}
      ...
      <motion.div className="admin-grid-2 admin-responsive-grid-main" style={{ gridTemplateColumns: '1fr 1fr' }} variants={fadeUp} transition={{ duration: 0.4, delay: 0.6 }}>
